...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "cursor-pointer border-b transition-colors hover:bg-fuas-secondary data-[state=selected]:bg-fuas-primary dark:hover:bg-neutral-800/50 dark:data-[state=selected]:bg-neutral-800",
      className
    )}
    {...props}
  />
